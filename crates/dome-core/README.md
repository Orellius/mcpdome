...
- Supplies helper methods for common message operations: tool name extraction, resource URI extraction, prompt name extraction, a unified `method_resource_name()` dispatcher, request/response classification, and error response construction.
